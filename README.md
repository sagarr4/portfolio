...
export const workExperience = [
  {
    ...
    desc: `Collaborated with users to gather requirements and design full-stack web applications using .NET (C#) and JavaScript, resulting in a 20% increase in user engagement.
Analyzed and optimized SQL Server databases to enhance performance, achieving a 30% improvement in query speed and system responsiveness.
Managed the full project lifecycle for 5+ applications, from initial planning through development, testing, and deployment.
Applied data analysis techniques to identify and implement usability improvements, increasing application intuitiveness by 15%.
Maintained high code quality using Git and streamlined deployment workflows, reducing release times by 20%.`,
    thumbnail: "/scoopsense.png", // replace with actual image path
  },
  // ...other experiences
];
